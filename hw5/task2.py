...
def transform_number(number, key):
    if key == 16:
        ...
        print("Неверно задан ключ. Работа будет закончена.")
        exit(-1)
    counter = 0
...
if __name__ == '__main__':
    fst_number = [digit for digit in input("Введите первое число в шестнадцатиричном формате: ")]
    scd_number = [digit for digit in input("Введите второе число в шестнадцатиричном формате: ")]
